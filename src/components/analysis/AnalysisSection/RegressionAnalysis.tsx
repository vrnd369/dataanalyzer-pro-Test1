  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-lg font-semibold text-black-500">Regression Analysis</h3>
      </div>

      <div className="space-y-8">
        {results.map((result, index) => (
          <div key={index} className="border-b border-black-100 pb-6 last:border-0">
            <h4 className="font-medium text-black-800 mb-2">{result.field}</h4>
