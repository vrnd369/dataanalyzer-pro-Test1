...
export function analyzeDataset(data: MarketData): Analysis {
  ...
  const fields: DataField[] = [
    { name: 'revenue', type: 'number', values: [data.revenue] },
    { name: 'customers', type: 'number', values: [data.customers] },
    { name: 'satisfaction', type: 'number', values: [data.satisfaction] },
    { name: 'marketShare', type: 'number', values: [data.marketShare] },
    { name: 'growthRate', type: 'number', values: [data.growthRate] }
  ];
